...
(async () => {
    ...
    const params = {
        ...
        PhoneNumber: '+919814893327', // Recipient's phone number from environment variables
        MessageAttributes: {
    ...
    const sns = new SNSClient({
        ...
        credentials: {
            accessKeyId: "AKIAZI2LFDY43PTNUN3M", // AWS access key from environment variables
            secretAccessKey: "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" // AWS secret key from environment variables
        }
    });
